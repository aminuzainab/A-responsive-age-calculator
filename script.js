...
function CalculateDate(e) {
    ...
    if (input_day.value === "") {
        ...
        input_day.classList.add("input-error");
        hasError = true;
    } else if (isNaN(parseInt(input_day.value, 10)) || +input_day.value <= 0 || +input_day.value > 31) {
    ...
    if (input_month.value === "") {
        ...
        input_month.classList.add("input-error");
        hasError = true;
    } else if (isNaN(parseInt(input_month.value, 10)) || +input_month.value <= 0 || +input_month.value > 12) {
        error_month.textContent = "Must be a valid month";
        input_month.classList.add("input-error");
        hasError = true;
    } else {
    ...
    if (input_year.value === "") {
        ...
        input_year.classList.add("input-error");
        hasError = true;
    } else if (isNaN(parseInt(input_year.value, 10)) || +input_year.value <= 0 || +input_year.value > new Date().getFullYear()) {
        error_year.textContent = "Must be a valid year";
        input_year.classList.add("input-error");
        hasError = true;
    } else {
