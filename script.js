...
function CalculateDate(e) {
    ...
    if (+input_day.value < 0 || +input_month.value < 0 || +input_year.value < 0) {
        error_day.textContent = +input_day.value < 0 ? "Must be a positive number" : "";
        error_month.textContent = +input_month.value < 0 ? "Must be a positive number" : "";
        error_year.textContent = +input_year.value < 0 ? "Must be a positive number" : "";
        input_day.classList.toggle("input-error", +input_day.value < 0);
        input_month.classList.toggle("input-error", +input_month.value < 0);
        input_year.classList.toggle("input-error", +input_year.value < 0);
